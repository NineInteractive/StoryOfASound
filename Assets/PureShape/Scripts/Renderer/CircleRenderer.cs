...
public class CircleRenderer : ShapeRenderer {
    ...
    void UpdateInnerMeshColor(Color newColor) {
        innerMeshController.color = newColor;
    }

    void UpdateBorderMeshColor(Color newColor) {
        outerMeshController.color = newColor;
    }
    ...
    void RemoveBorder() {
        using (var vh = new VertexHelper()) {
            outerMeshController.UpdateMesh(vh);
        }
    }
    ...
    void CreateInner() {
        ...
        using (var vh = new VertexHelper()) {
            ...
            innerMeshController.UpdateMesh(vh);
        }
    }
    ...
    Color color {
        get {
            return innerMeshController.color;
        }
